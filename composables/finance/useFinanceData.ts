...
export const useFinanceData = () => {
  ...
  const fetchOverview = async () => {
    try {
      const res = await $fetch('/api/v1/finance/overview', { ignoreResponseError: true })
  ...
  const fetchNetWorth = async () => {
    try {
      const res = await $fetch('/api/v1/finance/net-worth', { ignoreResponseError: true })
      netWorth.value = res?.data || null
    } catch (err) {
  ...
  const fetchCashFlow = async () => {
    try {
      const res = await $fetch('/api/v1/finance/cash-flow', { ignoreResponseError: true })
  ...
  const fetchTransactions = async (params?: any) => {
    try {
      ...
      const res = await $fetch(`/api/v1/finance/transactions${query}`, {
  ...
  const fetchBills = async () => {
    try {
      const res = await $fetch('/api/v1/finance/bills', { ignoreResponseError: true })
