...
export const detailedCategoryMap: Record<string, string> = {
  ...
  ENTERTAINMENT_SPORTING_EVENTS_AMUSEMENT_PARKS_AND_MUSEUMS:
    'Entertainment: Sporting Events Amusement Parks & Museums',
  ...
  GENERAL_SERVICES_ACCOUNTING_AND_FINANCIAL_PLANNING:
    'General: Services Accounting & Financial Planning',
  ...
  GOVERNMENT_AND_NON_PROFIT_GOVERNMENT_DEPARTMENTS_AND_AGENCIES:
    'Government: & Non Profit Government Departments & Agencies',
  GOVERNMENT_AND_NON_PROFIT_OTHER_GOVERNMENT_AND_NON_PROFIT:
    'Government: & Non Profit Other Government & Non Profit',
