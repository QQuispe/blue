...
class Logger {
  ...
  private log(level: string, levelNum: number, color: string, message: string, data?: Record<string, unknown>): void {
  ...
  debug(message: string, data?: Record<string, unknown>): void { this.log('DEBUG', 0, '#6b7280', message, data); }
  info(message: string, data?: Record<string, unknown>): void { this.log('INFO', 1, '#3b82f6', message, data); }
  success(message: string, data?: Record<string, unknown>): void { this.log('SUCCESS', 1, '#10b981', message, data); }
  warn(message: string, data?: Record<string, unknown>): void { this.log('WARN', 2, '#f59e0b', message, data); }
  error(message: string, data?: Record<string, unknown>): void { this.log('ERROR', 3, '#ef4444', message, data); }
